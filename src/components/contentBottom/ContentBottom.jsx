...
// <div>
//       <h1
//         className="text-workText text-center font-extrabold text-[40px] leading-[40px]
//       mt-10 mb-4"
//       >
//         What our customers are sayings
//       </h1>
//       <p className="text-blackNav text-center">
//         Enhance posture, mobility, and well-being effortlessly with Posture
//         Pro. Achieve proper alignment, reduce <br /> pain, and strengthen your
//         body with ease!
//       </p>

//       <div className=" mt-10 grid grid-cols-5 gap-6 mx-[-260px]">
//         {testimonials?.map((testimonial) => (
//           <div
//             key={testimonial?.id}
//             className={`p-8 bg-white rounded-3xl ${
//               testimonial?.id === 3 ? "max-h-max" : "mt-[50px] opacity-30"
//             }`}
//           >
//             <img src="/src/assets/reviewQuote.png" alt="" />

//             <p className="mt-2 font-medium text-workDesc">
//               {" "}
//               {/* {testimonial?.review} */}A posture corrector works by
//               providing support and gentle alignment to your shoulders, back,
//               and spine, encouraging you to maintain proper posture throughout
//               the day.
//             </p>
...
//       <div className=" cursor-pointer mt-[-20px] flex gap-8 items-center justify-center">
//         <div className="w-10 h-10 rounded-full bg-white flex justify-center items-center">
//           <img src="/src/assets/customers/arrow-left.svg" alt="" />
//         </div>

//         <div className="flex gap-2 items-center">
//           <img src="/src/assets/customers/Ellipse 2.svg" alt="" />
//           <img src="/src/assets/customers/Ellipse 6.svg" alt="" />
//           <img src="/src/assets/customers/Ellipse 6.svg" alt="" />
//           <img src="/src/assets/customers/Ellipse 6.svg" alt="" />
//           <img src="/src/assets/customers/Ellipse 6.svg" alt="" />
//           <img src="/src/assets/customers/Ellipse 6.svg" alt="" />
...
//         <div className="w-10 rounded-full h-10 bg-p1 flex justify-center items-center">
//           {" "}
//           <img src="/src/assets/customers/arrow-right.svg" alt="" />
//         </div>
//       </div>
//     </div>
